...
FUNCTION(link_ice)
    ...
    IF(WIN32)
        ...
        link_libraries(debug Iced)
        link_libraries(debug Glacier2d)
        link_libraries(debug IceUtild)
        link_libraries(optimized Ice)
        link_libraries(optimized Glacier2)
        link_libraries(optimized IceUtil)
    ELSE()
        link_directories(/usr/lib /usr/lib/c++11 /usr/lib64 /usr/lib64/c++11 /usr/lib/x86_64-linux-gnu/c++11)
        link_directories(${ICE_ROOT}/lib/x86_64-linux-gnu ${ICE_ROOT}/lib/x86_64-linux-gnu/c++11 ${ICE_ROOT}/lib64 ${ICE_ROOT}/lib64/c++11)
        link_directories(${ICE_ROOT}/lib ${ICE_ROOT}/lib/c++11)
        link_libraries(Ice Glacier2 IceUtil)
    ENDIF()
ENDFUNCTION()
