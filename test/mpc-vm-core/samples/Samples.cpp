...
int test_pb_add(const std::string& ir, int32_t va, int32_t vb)
{
	...
	//call the jit module
	char* result = nullptr;
	int result_len = PlatON_RunFuncByLazyJIT(ir.data(), "TestAdd", &result, inputs, lengths);
	if (result_len <= 0)
	{
    ...
    bool b = PlatON_ClearJITCache(ir.data());
    printf("b: %d\n", b);
...
#ifdef _WIN32
#ifndef _WIN64
    std::string ir = "E:/work/local/private-contract-compiler/build32/Release/bin/SimpleAndProto.cpp.ll";
    if (role == 2) {
        //ir = "E:/work/local/private-contract-compiler/build32/Debug/bin2/Samples.cpp.ll";
    }
#else
    std::string ir = "E:/work/local/private-contract-compiler/build/Release/bin/SimpleAndProto.cpp.ll";
    if (role == 2) {
        //ir = "E:/work/local/private-contract-compiler/build/Debug/bin2/Samples.cpp.ll";
    }
#endif
#else
...
int main(int argc, char** argv) 
{
    ...
    std::vector<std::string> libs{
        ...
        //      "E:/work/local/private-contract-vm2/build32/bin/Debug/emp-tool.dll",
    };
#else
    std::vector<std::string> libs{
        //      "E:/work/local/private-contract-vm/build/bin/Debug/mpc_vm_core.dll",
        //      "E:/work/local/private-contract-vm/build/bin/Debug/libprotobufd.dll",
        //      "E:/work/local/private-contract-vm/build/bin/Debug/libprotobuf-lited.dll"
        //      "E:/work/local/private-contract-vm2/build/bin/Debug/emp-tool.dll",
    };
#endif

#else
   //void* p =  dlopen("/root/work/y/private-contract-vm/build/lib/libprotobuf.so.3.6.1", RTLD_NOW| RTLD_GLOBAL);
   //printf("pppppp:%p\n", &p);
