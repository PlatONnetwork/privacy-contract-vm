...
std::string PlatonClient::get_ir_hash(const TransParams& transparams) {
    return std::string(::get_ir_hash());
}
std::string PlatonClient::get_ir_path(const TransParams& transparams) {
    return std::string(::get_ir_path());
}
std::string PlatonClient::get_ir_data(const TransParams& transparams) {
    return std::string(::get_ir_data());
}
std::string PlatonClient::get_participants(const TransParams& transparams) {
    return std::string(::get_participants());
}
std::string PlatonClient::get_urls(const TransParams& transparams) {
    return std::string(::get_urls());
}
